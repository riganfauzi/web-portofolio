...
export const FooterSection = (): JSX.Element => {
  ...
  return (
    <footer id="footer" className="relative flex flex-col w-full items-start gap-2.5 p-[90px] bg-foundation-bluenormal-active rounded-t-[32px] mt-12 overflow-hidden"> {/* Mengurangi margin atas */}
      <div className="flex flex-col lg:flex-row w-full items-start justify-between relative z-10 gap-12 lg:gap-0">
        {/* Contact Info Section */}
        <div className="flex flex-col w-full lg:max-w-[503px] items-start gap-[30px] relative">
        ...
        <div className="flex flex-col w-full lg:w-[500px] items-start gap-6 relative lg:mt-[60px]">
          <h3 className="font-heading-6 text-xl font-semibold text-white">Contact Me</h3>
          <form onSubmit={handleSubmit} className="flex flex-col w-full gap-4 relative z-10">
            <div>
              <Input
                id="name"
                type="text"
                ...
                className="w-full bg-white/20 text-foundation-blackblack-400 placeholder:text-foundation-blackblack-100 border-white/50 focus:border-white focus:ring-white"
              />
              {errors.name && (
            ...
            <Button
              type="submit"
              className="w-full bg-foundation-bluenormal-active text-white border border-white hover:bg-[#3C2B88] font-semibold py-3 rounded-md transition-colors"
              variant="default"
            >
              Send
            </Button>
            {submitMessage && (
              <p className={`text-center text-sm mt-2 ${errors.name || errors.email || errors.message ? 'text-red-300' : 'text-green-300'}`}>
                {submitMessage}
              </p>
            )}
          </form>
      ...
      <img
        ...
        alt="decoration"
        className="absolute bottom-[-50px] left-[-50px] w-[300px] h-[250px] object-contain z-0 opacity-20 hidden lg:block"
      />
    </footer>
  );
};
